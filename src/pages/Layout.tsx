...
const Layout = ({user, loginUser, cartItemsCount}: LayoutProps) => {
    ...
    return (
        <div className="content">
            <Header position={pos} backgroundColor={color} user={ user } loginUser={loginUser} cartItemsCount={cartItemsCount} />
            <Outlet />
            <Footer />
        </div>
    )
